    ...
    <section>
      ...
      <Container>
        <section className="divs">
          <div className="div1">
            <h2>
              Let’s walk you where your favorite events take place. Let’s Go!
            </h2>
            <p>
        ...
        <article className="Landart">
          <InputGroup className="mb-3 w-25">
            <FormControl placeholder="Email" aria-describedby="basic-addon2" />
            <Button className="btn-primary" id="button-addon2" type="submit">
              Sign up
            </Button>
          </InputGroup>
          <div className="opp">
            ...
            <div className="gains">
              ...
              <div className="app">
                <p>
                  <FaRegLifeRing /> Be more sociable
                </p>
              </div>

              <div className="app">
                <p>
                  <GiSmartphone /> Stay trendy
                </p>
              </div>

              <div className="app">
                <p>
                  <GiSmartphone /> Meet opportunities
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bright">
          <div className="browse">
            ...
            <div>
              ...
              <p>
                Stay in the know and never miss out on important events and
                community news. EventWalker includes updates on upcoming events
                and community news and attendees feedback.
              </p>
              <br />
              <br /> <br />
          ...
          <div>
            <div className="manager">
              ...
              <div>
                <p>
                  The communal feeling helps me to take inspired action, and
                  that's why I love organising events. When you have a passion
                  for something, enough to put on an event, at first that's
                  enough.
                </p>
                <p>Event Manager</p>
              </div>
            ...
            <div className="manager">
              ...
              <div class="bright">
                <p>
                  As an event planner you get to explore your creative vision
                  and see an idea be turned into reality, from concept to
                  execution.{" "}
                </p>
                <p>Event Manager</p>
              </div>
            ...
            <div className="manager">
              ...
              <div class="bright">
                <p>
                  Attending events gives me the exposure to people I would not
                  normally come into contact with. Additionally, it is likely
                  that I will meet an old friend which will give me the
        ...
        <section className="grid-container">
          <div className="miss">
            ...
            <p>
              {" "}
              It's crucial to stay up to date with what's happening day-to-day
            </p>
            <p>When we know what's going on, we can do our job better.</p>
          </div>

          <div className="pastevent-1">
            <img src={image9} alt="logo" />
            <p>Put a past Event here</p>
            <p>
              Attendant review <FaStar size="12px" />
              <FaStar size="12px" />
              <FaStar size="12px" />
            </p>
          </div>

          <div className="pastevent-2">
